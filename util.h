...
#define ESC "\x1b["
#define CODE_RESET ESC "0m"       // reset all attributes to their defaults
#define CODE_BOLD ESC "1m"        // set bold
#define CODE_DIM ESC "2m"         // set half-bright (simulated with color on a color display)
#define CODE_UL ESC "4m"          // set underscore (simulated with color on a color display) (the colors used to simulate dim or underline are set using ESC ] ...)
#define CODE_BLINK ESC "5m"       // set blink
#define CODE_RVSVID ESC "7m"      // set reverse video
#define CODE_NOTDIM ESC "22m"     // set normal intensity
#define CODE_NOUL ESC "24m"       // underline off
#define CODE_NOBLNK ESC "25m"     // blink off
#define CODE_NORVID ESC "27m"     // reverse video off
#define CODE_BLACK ESC "30m"      // set black foreground
#define CODE_RED ESC "31m"        // set red foreground
#define CODE_GREEN ESC "32m"      // set green foreground
#define CODE_BROWN ESC "33m"      // set brown foreground
#define CODE_BLUE ESC "34m"       // set blue foreground
#define CODE_MAGEN ESC "35m"      // set magenta foreground
#define CODE_CYAN ESC "36m"       // set cyan foreground
#define CODE_WHITE ESC "37m"      // set white foreground
#define CODE_ULDEFFG ESC "38m"    // set underscore on, set default foreground color
#define CODE_NOULDEFFG ESC "39m"  // set underscore off, set default foreground color
#define CODE_BGBLACK ESC "40m"    // set black background
#define CODE_BGRED ESC "41m"      // set red background
#define CODE_BGGREEN ESC "42m"    // set green background
#define CODE_BGBROWN ESC "43m"    // set brown background
#define CODE_BGBLUE ESC "44m"     // set blue background
#define CODE_BGMAGEN ESC "45m"    // set magenta background
#define CODE_BGCYAN ESC "46m"     // set cyan background
#define CODE_BGWITE ESC "47m"     // set white background
#define CODE_BGDEFLT ESC "49m"    // set default background color
...
#define STRY2(_cond_, _msg_...) TRYCATCH(_cond_, status, done2, _msg_) // disambiguate "done"
